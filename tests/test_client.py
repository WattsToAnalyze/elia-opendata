...
from elia_opendata.dataset_catalog import IMBALANCE_PRICES_PER_QH_NEAR_REALTIME
...
def test_get_records():
    ...
    endpoint = (
        f"catalog/datasets/{IMBALANCE_PRICES_PER_QH_NEAR_REALTIME}/records"
    )
    ...
    client = EliaClient()
    result = client.get_records(IMBALANCE_PRICES_PER_QH_NEAR_REALTIME, limit=2)
