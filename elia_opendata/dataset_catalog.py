...
This module contains all available dataset IDs from the Elia OpenData API
as simple constants. Users can import and use them directly.

Example usage:
    from elia_opendata.dataset_catalog import TOTAL_LOAD, IMBALANCE_PRICES_QH
    
    # Use dataset IDs directly
    data = client.get_records(TOTAL_LOAD)  # Uses "ods001"
    prices = client.get_records(IMBALANCE_PRICES_QH)  # Uses "ods134"
"""
